...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { active: @election.active, name: @election.name, publishable: @election.publishable, year: @election.year } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { active: @election.active, name: @election.name, publishable: @election.publishable, year: @election.year } }
