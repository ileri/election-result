...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post candidates_url, params: { candidate: { election_id: @candidate.election_id, name: @candidate.name, photo: @candidate.photo } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { election_id: @candidate.election_id, name: @candidate.name, photo: @candidate.photo } }
